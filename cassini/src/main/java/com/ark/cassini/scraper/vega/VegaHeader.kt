...
internal object Headers {
    fun applyDefaultHeaders(headers: HeadersBuilder) {
        headers.apply {
            ...
            append("DNT", "1")
            append("sec-ch-ua", "\"Not_A Brand\";v=\"8\", \"Chromium\";v=\"120\", \"Microsoft Edge\";v=\"120\"")
